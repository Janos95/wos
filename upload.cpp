        ...
        UploadFlags flags)
{
    ...
    using L = std::initializer_list<std::tuple<UploadFlags, VertexFormat, Trade::MeshAttribute>>;
    for(auto&& [flag, format, attribute] : L{
        {UploadFlag::AddNormalAttribute | UploadFlag::GenerateFlatNormals | UploadFlag::GenerateSmoothNormals, VertexFormat::Vector3, Trade::MeshAttribute::Normal},
        {UploadFlag::AddColorAttribute,                                                                        VertexFormat::Vector4, Trade::MeshAttribute::Color},
        {UploadFlag::AddTextureCoordinates,                                                                    VertexFormat::Vector2, Trade::MeshAttribute::TextureCoordinates}})
    {
        if (flags & flag)
    ...
    if (flags & UploadFlag::GenerateFlatNormals){
    ...
    else if(flags & UploadFlag::GenerateSmoothNormals)
